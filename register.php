...
if(isset($_POST['btn-signup']))
{
    ...
    $hashed_paasword=password_hash($upass,PASSWORD_DEFAULT);

    $check_email=$DBcon->query("SELECT a_email FROM admin WHERE a_email='email'");
    $count=$check_email->fetch_array();
    if($count==0)
    {
        $query="INSERT INTO admin(a_name,a_email,a_pass) VALUES('$uname','$email','$hashed_paasword')";
								...
								<div class="registration">
												...
												<div class="signin-form profile">
													...
													<p><a href="#"> By clicking Sign Up, I agree to your terms</a></p>
													 ...
													 <h6><a href="login.php">Log In Here</a><h6>
												</div>
										</div>
