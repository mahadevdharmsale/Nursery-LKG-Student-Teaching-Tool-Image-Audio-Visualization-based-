<?php
    ...
    if(isset($_POST['btn-login']))
    {
        ...
        $sql=$DBcon->query("SELECT a_id,a_email,a_pass FROM admin WHERE a_email='$email'");
        $row=$sql->fetch_array();

        $count=$sql->num_rows;
        if(password_verify ($password,$row['a_pass']) && $count==1)
        {
            $_SESSION['usersession']=$row['a_id'];
            header("location:home.php");
        }
        else
        {
								    ...
								    <div class="registration">
												...
												<div class="signin-form profile">
													...
													<p><a href="register.php"> Don't have an account?</a></p>
													 ...
													 <h6><a href="register.php">Back To Register </a><h6>
												</div>
										</div>
